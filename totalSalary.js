...
function totalSalary(salaryData){
    let companyTotalSalary = 0;
    for (const employee of salaryData) {
        const totalIncrement = employee.experience * employee.increment;
        const runningSalary = employee.starting + totalIncrement;
        companyTotalSalary += runningSalary;
    }
    return companyTotalSalary;
};
console.log("Total Salary:", totalSalary(employees), "Tk.") // Output: Total Salary: 149000 Tk.